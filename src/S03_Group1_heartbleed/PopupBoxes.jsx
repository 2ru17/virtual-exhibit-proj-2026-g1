...
export default function DraggablePopup({
  ...
  return (
    <div
      ...
      className="w-56 animate-popup-fade rounded-md border bg-hb-bg/95 font-body text-xs shadow-lg shadow-black/40"
    ...
    >
      ...
      <div
        ...
        className={`flex cursor-move items-center justify-between gap-1.5 border-b px-3 py-1.5 font-heading text-[10px] uppercase tracking-wide ${accentClass}`}
      >
